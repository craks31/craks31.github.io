...
import { FaDownload, FaFileDownload, FaLocationArrow, FaPhone } from "react-icons/fa";
      ...
      <div className="flex justify-center relative my-20 z-10 gap-3">
        <div className="flex justify-center items-center mt-4 mb-4">
          <img
            src="/images/dp.jpg"
            alt="Profile"
            className="w-32 h-32 md:w-42 md:h-42 lg:w-48 lg:h-48 rounded-full object-cover shadow-lg"
          />
        </div>
...
<div className="flex space-x-3 mt-2">
          <MagicButton
            title="Download CV"
            icon={<FaFileDownload></FaFileDownload>}
            position="right"
          />
